...
public class Buscador {
    ...
    // Tornando o método buscar estático
    public static Endereco buscar(String cep) throws IllegalArgumentException, IOException, Exception {
    ...
    // Tornando a classe interna EnderecoInterno estática para ser usada no método estático
    private static class EnderecoInterno {
        private String cep;
